...
# version.
#
# bbb-app-rooms is distributed in the hope that it will be useful, but WITHOUT ANY
# WARRANTY; without even the implied warranty of MERCHANTABILITY or FITNESS FOR A
# PARTICULAR PURPOSE. See the GNU Lesser General Public License for more details.
#
# You should have received a copy of the GNU Lesser General Public License along
# with bbb-app-rooms; if not, see <http://www.gnu.org/licenses/>.
...
namespace :attachments do
  ...
  task start: :environment do
    ...
    Rails.logger.info('Started mirroring process...')
  end
  ...
  task :finish, %i[new_service] => :environment do |_task, args|
    ...
    Rails.logger.info('Finished mirroring process...')
  end
end
